window.STATIC_MEMORIALS = [
    ...
    candles: [
      {
        id: 'candle-001',
        message:
          'Maverick was such a special dog. He will be deeply missed by all who knew him.',
    ...
    candles: [
      {
        id: 'candle-002',
        message:
          'Sochi was such a loving companion. Sending you comfort during this difficult time.',
        senderName: 'Michael Chen',
        createdAt: '2025-10-07T14:20:00.000Z'
      },
      {
        id: 'candle-003',
        message: 'What a beautiful tribute to a special friend. Sochi was lucky to have you.',
        senderName: 'Emily Davis',
        createdAt: '2025-10-07T16:45:00.000Z'
      }
    ],
    createdAt: '2025-10-08T07:50:00.000Z',
    clientIp: '192.0.2.45',
    deleted: false
  },
  {
    ...
    candles: [
      {
        id: 'candle-004',
        message: 'Elvis sounds like he was an amazing companion. What wonderful memories you have.',
        senderName: 'Lisa Rodriguez',
        createdAt: '2025-10-08T09:30:00.000Z'
      }
    ],
    createdAt: '2025-10-08T06:45:00.000Z',
  ...
  },
  {
    ...
    candles: [
      {
        id: 'candle-005',
        message: 'Cats have such a special place in our hearts. Le Chat was lucky to have you.',
        senderName: 'Amanda Foster',
        createdAt: '2025-10-07T11:15:00.000Z'
      }
    ],
    createdAt: '2025-10-07T12:20:00.000Z',
...
window.STATIC_USERS = {
  users: [
    {
      ownerName: 'Liz',
      firstPostDate: '2025-09-12T09:21:52.201Z',
      lastPostDate: '2025-10-10T14:21:52.201Z',
      totalPosts: 4,
      ip: '203.0.113.12'
    },
    {
      ownerName: 'Katy',
      firstPostDate: '2025-09-22T11:05:32.201Z',
      lastPostDate: '2025-10-09T18:42:12.201Z',
      totalPosts: 6,
      ip: '198.51.100.4'
    },
    {
      ownerName: 'Savannah',
      firstPostDate: '2025-09-25T14:37:06.297Z',
      lastPostDate: '2025-10-08T16:38:00.908Z',
      totalPosts: 8,
      ip: '192.0.2.45'
    },
    {
      ownerName: 'Josie',
      firstPostDate: '2025-09-18T12:17:22.297Z',
      lastPostDate: '2025-10-08T12:38:00.908Z',
      totalPosts: 3,
      ip: '198.51.100.26'
    },
    {
      ownerName: 'Lisa',
      firstPostDate: '2025-09-15T08:37:06.297Z',
      lastPostDate: '2025-10-07T10:18:00.908Z',
      totalPosts: 5,
      ip: '203.0.113.88'
    }
  ],
  bannedUsers: [
    {
      ...
      ip: '192.0.2.101',
      reason: '发布垃圾信息',
      bannedAt: '2025-10-01T10:00:00.000Z',
      originalUser: {
        ownerName: 'Mark',
        firstPostDate: '2025-09-10T09:15:00.000Z',
        lastPostDate: '2025-09-30T18:30:00.000Z',
        totalPosts: 2,
        ip: '192.0.2.101'
      }
    }
